...
- Prefers externalizing URLs and credentials to a config file rather than hardcoding them; works against external/staging environments with credentials supplied separately. Confidence: 0.7
